...
const categoryIcons = [
  ...
  <svg key="0" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <rect x="3" y="34" width="14" height="3" rx="1" fill="#E8B800"/>
    <rect x="3" y="39" width="14" height="3" rx="1" fill="#E8B800"/>
    ...
    <circle cx="21" cy="40" r="2" fill="#E8B800"/>
    <circle cx="37" cy="40" r="5" fill="currentColor" opacity="0.9"/>
    <circle cx="37" cy="40" r="2" fill="#E8B800"/>
  ...
  <svg key="1" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <circle cx="37" cy="40" r="5" fill="currentColor" opacity="0.9"/>
    <circle cx="37" cy="40" r="2" fill="#E8B800"/>
    <path d="M26 16 L22 24 L27 24 L23 32" stroke="#E8B800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>,
  // Reach Truck
  <svg key="2" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <rect x="4" y="36" width="14" height="3" rx="1" fill="#E8B800"/>
    <rect x="4" y="41" width="10" height="3" rx="1" fill="#E8B800"/>
    ...
    <line x1="4" y1="28" x2="16" y2="28" stroke="#E8B800" strokeWidth="1.5"/>
  </svg>,
  // Order Picker
  <svg key="3" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <rect x="4" y="30" width="12" height="3" rx="1" fill="#E8B800"/>
    <rect x="4" y="35" width="12" height="3" rx="1" fill="#E8B800"/>
  ...
  <svg key="4" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <rect x="9" y="10" width="26" height="3" rx="1.5" fill="#E8B800"/>
    <rect x="9" y="15" width="26" height="3" rx="1.5" fill="#E8B800"/>
  ...
  <svg key="5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <circle cx="12" cy="38" r="2.5" fill="#E8B800"/>
    <circle cx="30" cy="38" r="6" fill="currentColor" opacity="0.9"/>
    <circle cx="30" cy="38" r="2.5" fill="#E8B800"/>
    <rect x="34" y="30" width="10" height="2" fill="#E8B800" opacity="0.6"/>
  </svg>,
  // Battery / Parts
  <svg key="6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <path d="M24 18 L20 26 L25 26 L21 34" stroke="#E8B800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>,
]
...
export default function Categories() {
  ...
  return (
    <section id="categories" className="bg-industrial-800 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-heading font-medium text-gold-500 text-xs tracking-[0.3em] uppercase">{c.sectionBadge}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
              <h2 className="font-display text-5xl sm:text-6xl text-white tracking-wide">{c.sectionTitle}</h2>
              <p className="font-body text-industrial-400 mt-3 max-w-xl">{c.sectionSub}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {c.items.map((item, i) => (
            <div
              key={i}
              className={`group relative bg-industrial-900 border border-industrial-700 hover:border-gold-500/50 p-6 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] ${i === 0 ? 'lg:col-span-2 lg:row-span-1' : ''}`}
            >
              {/* Tag */}
              {item.tag && (
                <span className="absolute top-4 right-4 font-heading font-bold text-[10px] tracking-widest uppercase text-gold-500 bg-gold-500/10 border border-gold-500/30 px-2 py-0.5">
                  {item.tag}
                </span>
              )}

              {/* Icon */}
              <div className="text-industrial-400 group-hover:text-gold-400 transition-colors duration-300 mb-5">
                {categoryIcons[i]}
              </div>

              {/* Name */}
              <h3 className="font-heading font-semibold text-white text-lg mb-2 group-hover:text-gold-400 transition-colors duration-300 leading-snug">
                {item.name}
              </h3>
